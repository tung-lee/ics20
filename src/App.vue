	...
	export default {
		...
		data() {
			return {
				...
				config: {
					chainA: {
						endpoint: "https://testnet-rpc.orai.io",
						addrPrefix: "orai",
						gasPrice: "0.0001orai",
						mnemonic:
			...
			async sendIBCtransaction() {
				...
				const msg = {
					...
					value: {
						...
						sender: "orai15kkxnuwnshmtcrnc665nae6hnkjxktqhpzlzgh",
						receiver: "orai1w3qkhuhqnfwqmvptw3jtt6nct2y4y04vml8hyc",
				...
				console.log(this.transaction.rcptAddress)
				console.log(msg)
				const info = await client.signAndBroadcast(fromAccount.address, [msg], fee);
				console.log(info);
			},
			async relayerLoop(
